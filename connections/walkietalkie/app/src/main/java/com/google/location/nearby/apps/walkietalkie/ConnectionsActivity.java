...
public abstract class ConnectionsActivity extends AppCompatActivity {
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                ...
                public void onConnectionInitiated(@NonNull String endpointId,
                    ...
                    Endpoint endpoint =
                            new Endpoint(endpointId, connectionInfo.getEndpointName());
                ...
                public void onConnectionResult(@NonNull String endpointId,
                    ...
                    logD(String.format("onConnectionResponse(endpointId=%s, result=%s)", endpointId,
                            result));
    ...
    private final PayloadCallback mPayloadCallback = new PayloadCallback() {
        ...
        public void onPayloadTransferUpdate(@NonNull String endpointId,
            ...
            logD(String.format("onPayloadTransferUpdate(endpointId=%s, update=%s)", endpointId,
                    update));
        }
    };
